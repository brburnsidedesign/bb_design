const app = angular.module('app', ['ui.router', 'ngAnimate', 'ngMaterial', 'ngMessages', 'smoothScroll']);
...
app.config(['$urlRouterProvider', '$stateProvider',
	...
	$stateProvider
      ...
      .state('shop', {
          url					: '/shop',
          templateUrl : '/app/shop/shopMainView.html'
      })
      .state('terra_cotta', {
          url					: '/shop/item/terra_cotta',
          templateUrl : '/app/shop/item/terraCotta.html'
      })
      .state('remade_shadow', {
          url					: '/shop/item/remade_shadow',
          templateUrl : '/app/shop/item/shadowsMain.html'
      })
      .state('tubes', {
          url					: '/shop/item/tubes',
      ...
      .state('knucks', {
          url					: '/shop/item/knucks',
          templateUrl : '/app/shop/item/archesMain.html'
      })
      .state('more_is_more', {
          url					: '/shop/item/more_is_more',
          templateUrl : '/app/shop/item/moreIsMore.html'
      })
      .state('about', {
          url					: '/about',
